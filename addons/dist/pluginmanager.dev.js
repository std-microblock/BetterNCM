...
var postInstall = function postInstall(ind) {
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        ...
        case 3:
          ...
          return [4
          /*yield*/
          , fetch("http://music.163.com/betterncm_api/write_file?" + plugin["filepath"], {
            body: content,
            method: "POST"
          })];
...
var postUninstall = function postUninstall(ind) {
  return __awaiter(this, void 0, void 0, function () {
    var plugin;
    return __generator(this, function (_a) {
      switch (_a.label) {
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          ...
          return [4
          /*yield*/
          , fetch("https://ganbei-hot-update-1258625969.file.myqcloud.com/betterncm/online_addons.json?" + new Date().getTime())];
        ...
        case 5:
          if (!(_i < onlinePlugins_1.length)) return [3
          /*break*/
          , 12];
        ...
        case 6:
          ...
          return [4
          /*yield*/
          , fetch("http://music.163.com/betterncm_api/read_file?" + plugin["filepath"])];
